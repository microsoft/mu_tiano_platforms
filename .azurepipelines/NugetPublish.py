# @file NugetPublish.py
#
# This tool allows a user to create a configuration for nuget as well as
# pack and push (publishing) a release to a feed.
#
# NOTE: This file instance is a temporary copy of:
# https://github.com/tianocore/edk2-pytool-extensions/blob/master/edk2toolext/nuget_publishing.py
# that is currently used because the changes needed for repo support in the
# nuget-publish command are in the edk2-pytool-extensions 0.21.3 release but
# that release is not published to pypi.org yet.
##
