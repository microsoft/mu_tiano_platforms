...
[Defines]
  ...
  PLATFORM_GUID                  = D10C7386-9314-4BA6-A453-C4EA4C796344
...
!endif
  ...
  # For ArmVirt, we have to disable the periodic polling, because there is only one one serial port and the debug agent
...
!endif
  ...
  # UefiTestingPkg/FunctionalSystemTests/MpManagement/Driver/MpManagement.inf # KNOWN BROKEN ON ARMVIRT
  # UefiTestingPkg/FunctionalSystemTests/MpManagement/App/MpManagementTestApp.inf # KNOWN BROKEN ON ARMVIRT
  ...
  OemPkg/OemConfigPolicyCreatorDxe/OemConfigPolicyCreatorDxe.inf {
    <LibraryClasses>
      NULL|QemuArmVirtPkg/Library/ArmVirtConfigDataLib/ArmVirtConfigDataLib.inf
  }
...
!include NetworkPkg/Network.dsc.inc
  ...
  MdeModulePkg/Universal/SmbiosDxe/SmbiosDxe.inf {
    <LibraryClasses>
      NULL|QemuPkg/Library/SmbiosVersionLib/DetectSmbiosVersionLib.inf
  }
...
!if $(BUILD_UNIT_TESTS) == TRUE
  ...
  # MmSupervisorPkg/Test/MmPagingAuditTest/UEFI/MmPagingAuditApp.inf # NOT APPLICABLE TO ArmVirt
  # MmSupervisorPkg/Test/MmSupvRequestUnitTestApp/MmSupvRequestUnitTestApp.inf # NOT APPLICABLE TO ArmVirt
  ...
  # UefiTestingPkg/AuditTests/DMAProtectionAudit/UEFI/DMAIVRSProtectionUnitTestApp.inf # NOT APPLICABLE TO ArmVirt
  # TODO: Need to figure out the heap guard story first...
  ...
  # UefiTestingPkg/FunctionalSystemTests/ExceptionPersistenceTestApp/ExceptionPersistenceTestApp.inf # NOT APPLICABLE TO ArmVirt
  ...
  # UefiTestingPkg/FunctionalSystemTests/MemoryProtectionTest/App/SmmMemoryProtectionTestApp.inf # NOT APPLICABLE TO ArmVirt
  # UefiTestingPkg/FunctionalSystemTests/SmmPagingProtectionsTest/Smm/SmmPagingProtectionsTestSmm.inf # NOT APPLICABLE TO ArmVirt
  ...
  # UefiTestingPkg/FunctionalSystemTests/MemoryProtectionTest/Driver/SmmMemoryProtectionTestDriver.inf # NOT APPLICABLE TO ArmVirt
