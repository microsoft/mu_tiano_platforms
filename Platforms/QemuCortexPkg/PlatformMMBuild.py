...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("QemuCortexMMStandalone",)
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("QemuCortexPkg/QemuCortexMMPkg.dsc", {})

    def GetName(self):
        return "QemuCortexMMStandalone"
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "QemuCortexPkg/QemuCortexMMPkg.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "QemuCortexMMStandalone", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "QemuCortexPkg/QemuCortexMMPkg.dsc", "Platform Hardcoded")
